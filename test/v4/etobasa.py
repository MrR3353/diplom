...
class Blob:
    ...
    def save(self, path):
        ...
        if self.hash in os.listdir(os.path.join(VCS_FOLDER, DATA_FOLDER)):
...
class File:
    ...
    def load(self):
        ...
        :return:
        '''
        blob_path = os.path.join(VCS_FOLDER, DATA_FOLDER, self.blob)
...
class Tree:
    ...
    def save(self, path):
        ...
        if hash in os.listdir(os.path.join(VCS_FOLDER, DATA_FOLDER)):
            # такой объект уже есть в предыдущих коммитах, не сохраняем
            return
    ...
    def load(self):
        ...
        '''
        for i in range(len(self.children)):
            child_path = os.path.join(VCS_FOLDER, DATA_FOLDER, self.children[i])
...
class Commit:
    ...
    def load(self):
        ...
        '''
        # Ищем дерево
        tree_path = os.path.join(VCS_FOLDER, DATA_FOLDER, self.tree)
