...
class Blob:
    ...
    def save(self, path):
        ...
        '''
        with open(os.path.join(path, 'blobs', self.hash), 'wb') as file:
...
class File:
    ...
    def save(self, path):
        ...
        with open(os.path.join(path, 'files', self.hash), 'wb') as file:
            pickle.dump(self, file)
...
class Tree:
    ...
    def save(self, path):
        ...
        with open(os.path.join(path, 'trees', hash), 'wb') as file:
            pickle.dump(self, file)
...
class Commit:
    ...
    def save(self, path):
        ...
        os.mkdir(os.path.join(path, 'trees'))
        os.mkdir(os.path.join(path, 'files'))
        os.mkdir(os.path.join(path, 'blobs'))
        self.tree.save(path)
        self.tree = tree_hash
